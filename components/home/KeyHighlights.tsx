...
const KeyHighlights = () => {
  return (
    <div className=" flex justify-between flex-col md:flex-row lg:flex-row gap-4 lg:p-20">
      <div className="w-full md:w-[350px] lg:w-[350px]  transition-all duration-200  overflow-hidden flex flex-col gap-4">
      ...
      <div className="w-full md:w-[350px] lg:w-[350px]  transition-all duration-200  overflow-hidden flex flex-col justify-between gap-4 rounded-lg">
        <div className="p-4 shadow-md w-full h-80  md:w-[350px] lg:w-[350px] border border-gray-200 rounded-lg bg-blue-500 text-white flex  gap-3 flex-col justify-between">
          <div>
